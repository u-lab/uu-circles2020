<template>
  <div v-if="$route.name === 'index'" class="main-background">
    <v-img
      width="100vw"
      height="100vh"
    ...
    <v-row class="main-background-bottom">
      <v-col cols="3" class="main-background-bottom-l">
        <div class="text-center">
          <v-icon color="#fff">mdi-information-variant</v-icon>
          <p class="mb-0" style="font-size: 14px">重要な<br />お知らせ</p>
        </div>
      </v-col>

      <v-col cols="9" class="main-background-bottom-r">
        <p class="mb-0 text-center">
          新型コロナウイルス感染症によって新歓日程に変更が生じる可能性がございます
        </p>
      </v-col>
    </v-row>
  </div>
